...
function createMaterials() {
  ...
  floor_material[0] = new THREE.MeshBasicMaterial({ map: floor_texture, side: THREE.DoubleSide, wireframe:false });
  ...
  ball_material[1] = new THREE.MeshPhongMaterial( {color: 0xFFFFFF, bumpMap: ball_texture, wireframe:false, shininess:100} );
}
